...
func GenerateHelpers(schema *parser.Schema, outputDir string) error {
	...
	return generateHelpersFile(helpersFile)
}

// generateHelpersFile gera o arquivo com funções helper type-safe
func generateHelpersFile(filePath string) error {
	...
	// Imports - assumir que inputs está no mesmo nível (db/inputs)
	// O import será relativo ao module do usuário, então usamos um placeholder
	// que será substituído ou o usuário precisa configurar
	fmt.Fprintf(file, "import (\n")
	fmt.Fprintf(file, "\t\"time\"\n")
	fmt.Fprintf(file, "\t\"encoding/json\"\n")
	// Import será gerado como "../inputs" ou o usuário precisa ajustar
	// Por enquanto, vamos gerar um comentário e o usuário ajusta
	fmt.Fprintf(file, "\t// TODO: Ajustar o import abaixo para o caminho correto do seu module\n")
	fmt.Fprintf(file, "\tinputs \"../inputs\" // ou \"seu-module/db/inputs\"\n")
	fmt.Fprintf(file, ")\n\n")
